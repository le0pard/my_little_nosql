...
\vfill
  ...
  \hspace*{0.05\txtwidth}%
%\fbox{%
\parbox[b]{0.85\txtwidth}{
  \vbox{%
    \vspace{\drop}
    {\noindent\HUGE\bfseries My Little NoSQL}\\[2\baselineskip]
    {\Large\itshape handbook}\\[4\baselineskip]
    {\Large Alexey Vasiliev aka leopard}\par
    \vspace{0.5\txtheight}
    {\noindent http://leopard.in.ua}\\{\noindent 2012}\\[\baselineskip]
    }% end of vbox
}% end of parbox
%}% end of fbox
  }% end of hbox
