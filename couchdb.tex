...
\subsection{Powerful MapReduce}

Design documents are a special type of CouchDB document that contains application code. Because it runs inside a database, the application API is highly structured.\cite{couchdb_book}
